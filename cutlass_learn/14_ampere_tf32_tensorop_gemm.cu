...
// This code section describes whether you want to use tensor cores or regular SIMT cores on GPU SMs
...
using ShapedMMAThreadBlock = cutlass::gemm::GemmShape<128, 128, 16>;
