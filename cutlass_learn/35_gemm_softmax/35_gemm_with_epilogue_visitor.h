            ...
            public:
                ...
                struct Params
                {
                        ...
                        epilogue_visitor(args.epilogue_visitor)
                    {
                        ...
                        if (args.mode == GemmUniversalMode::kGemm || args.mode ==
                            GemmUniversalMode::kGemmSplitKParallel)
                        {
...
#define SPLIT_K_ENABLED 1
                ...
                void operator()(Params const& params, SharedStorage& shared_storage)
                {
                    ...
                    int block_idx = threadblock_tile_offset.m() + threadblock_tile_offset.n() * params.grid_tiled_shape.
                        m();
