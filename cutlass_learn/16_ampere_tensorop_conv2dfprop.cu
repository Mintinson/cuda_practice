...
struct Options
{
    ...
    Options():
        ...
        filter_size(32, 3, 3, 32), // outC, H, W, inC
        padding(1, 1, 1, 1),
        conv_stride(1, 1),
        dilation(1, 1),
    ...
    void update(cutlass::Tensor4DCoord input_size, cutlass::Tensor4DCoord filter_sie)
    {
