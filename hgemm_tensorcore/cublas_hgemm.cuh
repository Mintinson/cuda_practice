#ifndef CUBLAS_HGEMM_CUH_
#define CUBLAS_HGEMM_CUH_
...
namespace cublas {
template <bool Tensor, typename T>
void cublas_hgemm(const T* A, const T* B, T* C, size_t row, size_t col, size_t depth)
{
    T* d_a;
    T* d_b;
    T* d_c;
    ...
    cublasGemmEx(handle, CUBLAS_OP_N, CUBLAS_OP_N, col, row, depth, &alpha, d_b,
        CUDA_R_16F, col, d_a, CUDA_R_16F, depth, &beta, d_c, CUDA_R_16F, col,
